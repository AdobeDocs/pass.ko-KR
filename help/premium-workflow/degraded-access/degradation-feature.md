...
이 기능은 [사용 모니터링 API](/help/premium-workflow/esm/entitlement-service-monitoring-overview.md)와 함께 사용하도록 설계되었으며 MVPD와의 사전 계약에 따라 Adobe Pass 인증은 중요한 순간 동안 사용자 경험, 안정성 및 운영 제어의 균형을 맞출 수 있는 강력한 도구를 제공합니다.
