...
> <br/>
>
> * 스트리밍 응용 프로그램이 프로그래머에게 적용되는 [온보딩 필수 구성 요소](/help/premium-workflow/sso-access/partner-sso/apple-sso/apple-sso-overview.md#apple-sso-prerequisites-programmer)를 완료했으며 Apple SSO(Single Sign-On) 사용자 환경을 사용하도록 설정하는 데 필요합니다.
