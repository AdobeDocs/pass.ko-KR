...
**설명:** 이 방법은 응용 프로그램의 UI 장식(예: 잠금 및 잠금 해제 아이콘으로 액세스 상태 표시)의 주요 목적으로, 응용 프로그램에서 인증된 사용자의 사전 권한 부여(정보) 결정을 Adobe Pass 인증 서비스에서 가져와 특정 보호된 리소스를 보는 데 사용됩니다.
...
* 의 경우 0일 수 있습니다. `Status` 는 Adobe Pass 인증 서비스 대신 SDK에서 가져옵니다.
