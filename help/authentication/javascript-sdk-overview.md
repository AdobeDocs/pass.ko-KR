...
일반 Adobe Pass 인증 권한 플로우는에서 다룹니다. [프로그래머 권한 흐름](/help/authentication/entitlement-flow.md)및 JavaScript 통합 Cookbook에서는 구현을 안내합니다. 다음 섹션에서는 JavaScript AccessEnabler 통합과 관련된 설명 및 샘플을 제공합니다.
