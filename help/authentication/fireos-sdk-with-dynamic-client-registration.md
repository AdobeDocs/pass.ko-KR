...
**FireOS SDK 3.0.4**&#x200B;은(는) 서명된 요청자 ID 및 세션 쿠키 인증을 기반으로 현재 앱 등록 메커니즘을 [Dynamic Client Registration](/help/authentication/dynamic-client-registration.md)(으)로 대체합니다.
