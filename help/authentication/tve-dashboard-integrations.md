...
![인증, 권한 부여 및 로그아웃 흐름을 위한 끝점](assets/endpoint-selection.png)
...
이 섹션에서는 모든 [플랫폼](/help/authentication/tve-dashboard-reports.md#platforms)에서 통합 설정을 보고 편집할 수 있습니다. 개별 플랫폼에 따라 이러한 설정을 변경할 수 있습니다. 예를 들어 다른 플랫폼에 대한 기본값을 유지하면서 Android에서 인증 TTL 기간을 조정할 수 있습니다.
...
선택 위에서 설명한 각 상속 수준에 사용되는 속성을 살펴보기 위해 각 속성의 오른쪽에 있는 <img alt= "상속 체인 아이콘" src="./assets/multiple-icon.svg" width="25"> 아이콘
...
모든 플랫폼에서 **AuthN TTL** 및 **AuthZ TTL**&#x200B;의 기간은 [변경 내용을 검토하고 푸시](/help/authentication/tve-dashboard-review-push-changes.md)한 후에만 업데이트됩니다.
...
1. **플랫폼 설정**&#x200B;에서 SSO(Single Sign-On)를 활성화할 특정 플랫폼 또는 플랫폼 범주를 선택하십시오.
   ...
   ![특정 플랫폼에 대해 SSO(Single Sign-On) 사용](assets/single-sign-on.png)
...
선택한 플랫폼에 대한 **Single Sign On** 속성은 [변경 내용을 검토하고 푸시한 후에](/help/authentication/tve-dashboard-review-push-changes.md)만 사용 또는 사용 안 함으로 설정됩니다.
...
특정 MVPD에 대한 **시도 HBA** 속성은 [변경 내용 검토 및 푸시](/help/authentication/tve-dashboard-review-push-changes.md)한 후에만 활성화되거나 비활성화됩니다.
...
**Preflight 최대 리소스** 속성은 [변경 내용 검토 및 푸시](/help/authentication/tve-dashboard-review-push-changes.md) 후에만 추가됩니다.
...
**표시 이름** 또는 **로고 URL** 속성은 [변경 내용 검토 및 푸시](/help/authentication/tve-dashboard-review-push-changes.md) 후에만 추가됩니다.
...
![집계 속성별 인증 추가](assets/auth-per-aggregator.png)

*집계 속성별 인증 추가*

**집계당 인증** 속성은 [변경 내용 검토 및 푸시](/help/authentication/tve-dashboard-review-push-changes.md) 후에만 추가됩니다.

추가한 후에는 **예**&#x200B;를 선택하여 선택한 통합에 대해 **집계당 인증** 속성을 사용하도록 설정합니다.

#### 속성 삭제 {#delete-properties}

선택 더 이상 필요하지 않은 속성을 삭제하려면 각 속성의 오른쪽에 있는 <img alt= "속성 삭제 단추" src="./assets/delete-icon.svg" width="25"> 아이콘을 클릭합니다.

>[!NOTE]
>
>특정 속성은 선택한 MVPD에 대한 필수 요구 사항이므로 제거할 수 없습니다.

속성은 [변경 내용 검토 및 푸시](/help/authentication/tve-dashboard-review-push-changes.md)한 후에만 **플랫폼 설정** 섹션에서 삭제됩니다.
...
[프로그래머](/help/authentication/tve-dashboard-programmers.md#available-certificates) 및 [채널](/help/authentication/tve-dashboard-channels.md#available-certificates) 섹션에서 사용 가능한 인증서에 대해 자세히 알아보세요.

**활성화됨**: 이 열에서 드롭다운 메뉴에서 각각 **예** 또는 **아니요**&#x200B;를 선택하여 API에서 매개 변수를 활성화하거나 비활성화할 수 있습니다.

![사용자 메타데이터에 사용할 수 있는 매개 변수](assets/user-metadata.png)
...
1. **통합** 섹션의 오른쪽 상단에서 **새 통합 만들기**&#x200B;를 선택합니다.
   ...
   **끝점 선택**
   ...
   ![끝점 ](assets/select-endpoints.png) 선택
...
새 통합은 [변경 내용을 검토하고 푸시](/help/authentication/tve-dashboard-review-push-changes.md)한 후에만 만들어집니다.
...
[변경 내용을 검토하고 푸시한](/help/authentication/tve-dashboard-review-push-changes.md) 후에만 통합이 비활성화됩니다.
