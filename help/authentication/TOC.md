...
+ 프로그래머 통합 안내서 {#programmer-integration-guide}
   ...
   + REST API V2 {#rest-api-v2}
      ...
      + [REST API V2 FAQ](./rest-api-v2/rest-api-v2-faqs.md)
      ...
      + Cookbook {#rest-api-v2-cookbooks}
         + [REST API V2 Cookbook(클라이언트-서버)](rest-api-v2/cookbooks/rest-api-v2-cookbook-client-server.md)
         + [REST API V2 Cookbook(서버 간)](rest-api-v2/cookbooks/rest-api-v2-cookbook-server-server.md)
