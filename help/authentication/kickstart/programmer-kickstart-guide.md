...
이 킥스타트 안내서는 ® 인증 전달을 웹 사이트 또는 애플리케이션에 통합하려는 콘텐츠 공급자(프로그래머)를 대상으로 합니다.
...
![® 인증 통합 프로세스 통과](../assets/progr-flow-int-lifecycle.png)
...
**Adobe은 [Adobe Pass TVE 대시보드](https://experience.adobe.com/pass/authentication)를 통해 구성 및 데이터를 관리하기 위한 셀프서비스 도구에 대한 액세스 권한을**&#x200B;제공합니다.
