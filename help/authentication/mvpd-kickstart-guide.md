...
>[!NOTE]
>
>멀티채널 비디오 프로그래밍 디스트리뷰터(MVPD)를 위한 킥스타트 안내서입니다. 프로그래머(콘텐츠 공급자)인 경우 [프로그래머 킥스타트 안내서](/help/authentication/programmer-kickstart-guide.md)를 참조하십시오.
...
명확히 할 항목은 [MVPD 통합 기능](/help/authentication/mvpd-integr-features.md)을 참조하십시오.
...
Adobe 환경을 사용하는 방법에 대한 자세한 내용은 [Adobe 환경 이해](/help/authentication/understanding-the-adobe-environments.md)를 참조하십시오
...
이 단계에서는 Adobe 및 MVPD를 테스트하고 통합 문제를 해결합니다. 통합 테스트를 지원하기 위해 Adobe Pass 인증 팀은 Adobe의 API 테스트 사이트를 사용할 수 있습니다. Adobe의 API 테스트 사이트 사용에 대한 자세한 내용은 [Adobe API 테스트 사이트를 사용하여 인증 및 권한 부여 흐름 테스트](/help/authentication/test-authn-authz-flows-using-adobes-api-test-site.md)를 참조하십시오.
