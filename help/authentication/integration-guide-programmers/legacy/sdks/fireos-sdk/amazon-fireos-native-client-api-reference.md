...
| API 호출: 생성자 |
| --- |
| <code>공용 정적 AccessEnabler getInstance(Context appContext, String softwareStatement, String redirectUrl)<br> AccessEnablerException 발생<br><br> 공용 정적 AccessEnabler getInstance(Context appContext, String env_url, String softwareStatement, String redirectUrl) AccessEnablerException 발생 </code> |
...
| **Callback: 인증 흐름 실패** |
| --- |
| <code>공개 void tokenRequestFailed(String resourceId, <br> String errorCode, String errorDescription)</code> |
