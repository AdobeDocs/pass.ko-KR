...
&#39;&amp;&#39;가 없으며 Adobe에서 토큰과 연결할 `regCode` 매개 변수를 찾을 수 없으므로 요청자\_id는 univion®\_code=EKAFMFI로 해석됩니다.  AuthN 토큰이 전혀 만들어지지 않을 수 있습니다. 이 경우 `/checkauthn`개의 호출에서 토큰을 찾을 수 없습니다.
