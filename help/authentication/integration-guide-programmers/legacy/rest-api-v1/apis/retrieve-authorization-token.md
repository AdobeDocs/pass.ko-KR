...
| --- | --- | --- | --- | --- | --- |
| &lt;SP_FQDN>/api/v1/tokens/authz</br></br>예: </br></br>&lt;SP_FQDN>/api/v1/tokens/authz | 스트리밍 앱</br></br>또는</br></br>프로그래머 서비스 | &#x200B;1.  요청자(필수)</br>2.  deviceId(필수)</br>3.  리소스(필수)</br>4.  device_info/X-Device-Info(필수)</br>5.  _deviceType_</br> 6.  _deviceUser_(사용하지 않음)</br>7.  _appId_(더 이상 사용되지 않음) | GET | &#x200B;1.  성공</br>2.  인증 토큰 </br>을(를) 찾을 수 없거나 만료되었습니다. </br> 인증 토큰을 찾을 수 없는 이유 </br>을(를) 설명하는 XML입니다</br>3.  인증 토큰 </br>을(를) 찾을 수 없습니다. </br> XML 설명</br>4.  인증 토큰 </br>이(가) 만료됨: </br> XML 설명 | 200 - 성공 </br>412 - AuthN 없음</br></br>404 - AuthZ 없음</br></br>410 - AuthZ 만료됨 |
