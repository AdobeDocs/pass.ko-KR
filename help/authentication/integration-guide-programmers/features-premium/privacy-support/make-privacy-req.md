...
>[!IMPORTANT]
>
>Adobe Pass 인증에 대한 개인 정보 요청을 생성하려면 사용자가 인증되어야 합니다. 그렇지 않으면 프로그래머는 MVPD 사용자 ID를 추출할 수 있는 다른 방법을 찾아야 합니다.
...
**Privacy Service API 설명서**&#x200B;에서는 Adobe 고객이 Adobe API와 통합하는 방법에 대해 자세히 설명합니다.
