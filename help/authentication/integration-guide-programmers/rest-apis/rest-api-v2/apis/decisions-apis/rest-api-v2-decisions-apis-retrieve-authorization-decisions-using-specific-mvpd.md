...
<table style="table-layout:auto">
   ...
   <tr>
      ...
      <td>
         ...
         application/json;charset=utf-8이어야 합니다.</td>
      <td><i>필수</i></td>
   </tr>
   <tr>
...
<table style="table-layout:auto">
   ...
   <tr>
      ...
      <td>잘못된 요청</td>
      <td>
        요청이 잘못되었습니다. 클라이언트가 요청을 수정하고 다시 시도하십시오. 응답 본문에는 <a href="../../../../features-standard/error-reporting/enhanced-error-codes.md">향상된 오류 코드</a> 설명서와 관련된 오류 정보가 포함될 수 있습니다.</td>
   </tr>
   <tr>
      <td>401</td>
      <td>승인되지 않음</td>
      ...
      <td>
         ...
         <table style="table-layout:auto">
            ...
            <tr>
               ...
               <td>
                  미디어 토큰에 대한 정보입니다.<br/><br/>
                  다음 속성이 있는 JSON 개체:<ul>
...
### &#x200B;1. 결정이 허용되는 동안 특정 mvpd를 사용하여 권한 부여 결정을 검색합니다.
...
### &#x200B;3. 저하가 적용되는 동안 특정 mvpd를 사용하여 권한 부여 결정을 검색합니다.
...
### &#x200B;5. 프로모션 TempPass를 사용하여 인증 결정 검색
