...
<table>
   ...
   <tr>
      ...
      <td>재생되기 전에 MVPD 결정이 필요한 리소스 목록입니다.</td>
      <td><i>필수</i></td>
   </tr>
   <tr>
...
<table>
   ...
   <tr>
      ...
      <td>잘못된 요청</td>
      <td>
        요청이 잘못되었습니다. 클라이언트가 요청을 수정하고 다시 시도하십시오. 응답 본문에는 <a href="../../../enhanced-error-codes.md">향상된 오류 코드</a> 설명서와 관련된 오류 정보가 포함될 수 있습니다.
      </td>
   </tr>
   <tr>
      <td>401</td>
            ...
            <tr>
               ...
               <td>
                  ...
                  <table>
                     ...
                     <tr>
                        <td style="background-color: #DEEBFF;">mvpd</td>
                        <td>MVPD 인증 끝점에 의해 결정이 발급되었습니다.</td>
                     </tr>
                     <tr>
               ...
               <td>
                  ...
                  <table>
                     ...
                     <tr>
                        ...
                        <td>미디어 토큰이 잘못되기 전의 타임스탬프입니다.</td>
                     </tr>
                     <tr>
                        <td style="background-color: #DEEBFF;">notAfter</td>
                        <td>미디어 토큰이 잘못된 타임스탬프.</td>
                     </tr>
                     <tr>
                        <td style="background-color: #DEEBFF;">serializedToken</td>
                        <td>Base64로 인코딩된 미디어 토큰입니다.</td>
                     </tr>
                  </table>
               <td>선택 사항</td>
            </tr>
...
### 4. 성능이 저하된 mvpd를 사용하여 권한 부여 결정 검색
