...
### 1. 모든 필수 매개 변수에 대한 값을 제공하면서 인증 세션을 만듭니다.
...
### 2. 없음 또는 일부 필수 매개 변수에 대한 값을 제공하면서 인증 세션을 만듭니다.
...
### 3. mvpd 매개 변수에 대한 값을 제공하고 유효한 인증된 프로필이 이미 있는 동안 인증 세션을 만듭니다.
...
### 4. mvpd 매개 변수에 대한 값을 제공하고 성능 저하가 있는 동안 인증 세션을 만듭니다.
