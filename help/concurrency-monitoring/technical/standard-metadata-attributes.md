...
동시성 모니터링 API는 클라이언트가 유효한 초기화 호출의 일부로 다음 값을 보내도록 강제합니다. [세션 시작 호출](/help/concurrency-monitoring/technical/restrict-concurr-usage-mult-apps.md#api-calls-descr).
...
[API v2.0](https://streams-stage.adobeprimetime.com/swagger-ui/index.html)을(를) 사용하면 정의된 정책에 이러한 특성이 필요한 경우 해당 특성이 없는 세션 초기화 시도에 의해 400 잘못된 요청이 발생합니다.
...
* [정책 결정 지점](/help/concurrency-monitoring/technical/cm-policy-decision-point.md)
* [API 콘솔 - Adobe 동시 모니터링](https://streams-stage.adobeprimetime.com/swagger-ui/index.html)
